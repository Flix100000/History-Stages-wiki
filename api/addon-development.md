...
History Stages has **Lootr** as a required dependency, so your dev environment needs it too — History Stages will not load without it. See [Mod Compatibility](/docs/modpack-developers/mod-compatibility) for why.
