...
:::note
These pages describe **6.0.x**, the NeoForge 1.21.1 build. Forge 1.20.1 is on 5.6.x and Fabric 1.21.1 on 5.2.x — use the version picker in the top bar to read the documentation that matches what you run. The 1.19.X builds are no longer updated.
:::
