...
- **[Scripting: KubeJS](./scripting-kubejs.md)** — JavaScript, `server_scripts` and `client_scripts`.
- **[Scripting: CraftTweaker](./scripting-crafttweaker.md)** — ZenScript, including the `player.hasStage(...)` shortcut.
