---
id: getting-started
title: Getting Started with History Stages
sidebar_label: Getting Started
---

History Stages is a versatile progression and gatekeeping mod for Minecraft on both **Forge** and **NeoForge** platforms. This document outlines the installation process and initial steps for creating stages.
