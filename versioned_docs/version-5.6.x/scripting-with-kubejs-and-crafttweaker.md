---
id: scripting-with-kubejs-and-crafttweaker
title: Scripting with KubeJS and CraftTweaker
sidebar_label: Scripting (KubeJS & CraftTweaker)
---
...
Category ids are namespaced. The fifteen built-in ones live under `historystages:`, and you may
